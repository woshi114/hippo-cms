...
public class SimpleLoginPlugin extends LoginPlugin {
    ...
    private static final Logger log = LoggerFactory.getLogger(SimpleLoginPlugin.class);
    ...
    public SimpleLoginPlugin(IPluginContext context, IPluginConfig config) {
        ...
        add(CSSPackageResource.getHeaderContribution(new CompressedResourceReference(SimpleLoginPlugin.class, "login.css")));
        ...
        if(config.containsKey(EDITION_PROPERTY)) {
            ...
            add(CSSPackageResource.getHeaderContribution(
                    new CompressedResourceReference(SimpleLoginPlugin.class, "login_" + edition + ".css")));
        }
    ...
    protected class SignInForm extends org.hippoecm.frontend.plugins.login.LoginPlugin.SignInForm {
        ...
        public SignInForm(final String id) {
            ...
            add(new AttributeModifier("autocomplete", new Model<String>(autocomplete ? "on" : "off")));
