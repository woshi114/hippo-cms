...
//                            }
            ...
            */
            isFullScreen : function() {
                ...
                //return Lang.isObject(t.instance.editor) && Lang.isBoolean(t.instance.editor._isFullScreen) && t.instance.editor._isFullScreen;
            },
            ...
            getFullscreenPlugin : function() {
                ...
                for(var i=0; i<candidates.length; i++) {
                    ...
                    if(Lang.isObject(t.instance) && Lang.isObject(t.instance.editor)) {
                      return t;
                    }
                }
                return null;
