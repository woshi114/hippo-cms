...
public class TranslateWorkflowImpl implements TranslateWorkflow, InternalWorkflow {
    ...
    @Override
    public void translate(final String targetLanguage, final Set<String> fields) throws WorkflowException, RepositoryException, RemoteException {
        translate(null, targetLanguage, fields);
    }
    ...
    protected void translate(String sourceLanguage, String targetLanguage, List<String> texts) throws WorkflowException, RepositoryException {
        try {
            final String parameters = createParameters(texts, sourceLanguage, targetLanguage);
    ...
    private String createParameters(final List<String> texts, final String sourceLanguage, final String targetLanguage) throws UnsupportedEncodingException {
