...
/**
 * Extension of the {@link org.hippoecm.frontend.plugins.yui.upload.MagicMimeTypeFileItem} that tries to close all opening stream before deletion. It fixes errors in deleting
