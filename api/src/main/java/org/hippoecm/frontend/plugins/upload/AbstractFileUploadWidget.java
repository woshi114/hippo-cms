...
public abstract class AbstractFileUploadWidget extends Panel {
     ...
     * {@link #AbstractFileUploadWidget(String, org.hippoecm.frontend.plugin.config.IPluginConfig, org.hippoecm.frontend.plugins.yui.upload.validation.FileUploadValidationService)} then call {@link #onFileUpload(org.apache.wicket.markup.html.form.upload.FileUpload)}
     *
     * @param fileUpload
