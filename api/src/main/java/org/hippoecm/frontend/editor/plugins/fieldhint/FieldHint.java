...
import java.lang.String;import org.apache.commons.lang.StringUtils;
...
public class FieldHint extends Panel {
    public FieldHint(String id, final String hint) {
        ...
        add(CSSPackageResource.getHeaderContribution(FieldHint.class, "FieldHint.css"));
        add(createHint(hint));
    }
    ...
    protected Component createHint(final String hint) {
        ...
        if (StringUtils.isBlank(hint)) {
            ...
            hintContainer.add(new Image("hint-image", new ResourceReference(FieldHint.class, "hint.png")));
        }
