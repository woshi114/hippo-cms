...
public class RevertDialog extends WorkflowDialog<WorkflowDescriptor> {

    public RevertDialog(IModel<String> title, WorkflowDescriptorModel model, IModel<String> notification,
        ...
        add(CssClass.append("hippo-revert-dialog"));
