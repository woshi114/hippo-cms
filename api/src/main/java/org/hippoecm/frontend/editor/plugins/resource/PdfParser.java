...
public class PdfParser {
    ...
    private String parse(final InputStream inputStream) {
     ...
     * @return the first 100*1000 chars from the pdf as String. Also see {@link Tika#setMaxStringLength(int)}
     * @throws IllegalStateException in case of a {@link TikaException} or {@link IOException}
     */
