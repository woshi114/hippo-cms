...
public class CodecUtils {
    ...
    public static StringCodec getNodeNameCodec(final IPluginContext context, final Node node) {
        final String locale = getLocaleFromNode(node);
    ...
    /**
     * Return the value of property {@link HippoTranslationNodeType#LOCALE} for the first translated node found while 
     * traversing the ancestor subtree of argument node. If no such node is found in subtree, return null.
     * 
