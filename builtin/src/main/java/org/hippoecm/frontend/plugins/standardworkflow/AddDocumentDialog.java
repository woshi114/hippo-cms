...
public class AddDocumentDialog extends AbstractWorkflowDialog<AddDocumentArguments> {
    ...
    public AddDocumentDialog(AddDocumentArguments addDocumentModel, IModel title, String category, Set<String> prototypes, boolean translated, final IWorkflowInvoker invoker, final StringCodec nodeNameCodec, ILocaleProvider localeProvider) {
        super(new Model(addDocumentModel), invoker);
        this.title = title;
        ...
        AjaxLink<Boolean> uriAction = new AjaxLink<Boolean>("uriAction") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                if (!uriModified) {
                    uriModel.setObject(Strings.isEmpty(nameModel.getObject()) ? "" : nodeNameCodec.encode(nameModel.getObject()));
