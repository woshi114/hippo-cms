...
public class FolderShortcutPlugin extends RenderPlugin {
    ...
    public class Dialog extends AbstractDialog<WorkflowDescriptor> {
        ...
        public Dialog(IPluginContext context, IPluginConfig config, Node folder, String defaultFolder) {
            ...
            prototypeContainer.add(prototypeChoice = new DropDownChoice<>("select", new PropertyModel<String>(this, "prototype"),
                    emptyList));
            ...
            templateContainer.add(templateChoice = new DropDownChoice<>("select", new PropertyModel<String>(this,
