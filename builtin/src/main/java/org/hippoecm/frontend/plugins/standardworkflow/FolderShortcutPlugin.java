...
public class FolderShortcutPlugin extends RenderPlugin {
                        ...
                        try {
                            if (workflow instanceof EditableWorkflow) {
                                ...
                                if (editableDocument != null) {
                                    ...
                                    editNodeModel = new JcrNodeModel(jcrSession.getNodeByIdentifier(editableDocument
                                            .getIdentity()));
                                } else {
                                    editNodeModel = null;
                                }
    ...
    public class Dialog extends AbstractDialog {
        ...
        public Dialog(IPluginContext context, IPluginConfig config, Node folder, String defaultFolder) {
            ...
            prototypeContainer.add(prototypeChoice = new DropDownChoice<String>("select", new PropertyModel<String>(this, "prototype"),
                    emptyList));
