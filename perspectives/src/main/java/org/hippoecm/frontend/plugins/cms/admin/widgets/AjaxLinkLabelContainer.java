...
/**
 * The AjaxLinkLabelContainer is a container for an AjaxFallBackLink, with attached to this link a label. Because it is
 * a container a getter is exposed to public in order to get the AjaxFallbackLink
 */
