...
public class SetMembershipsPanel extends Panel {
    ...
    private void showError(final String s, final AjaxRequestTarget target) {
        hippoForm.error(s);
        updateFeedbackPanel(target);
    }

    private void showInfo(final String s, final AjaxRequestTarget target) {
        hippoForm.info(s);
        updateFeedbackPanel(target);
    }

    private void updateFeedbackPanel(final AjaxRequestTarget target) {
