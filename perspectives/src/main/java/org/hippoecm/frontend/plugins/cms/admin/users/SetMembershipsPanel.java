...
public class SetMembershipsPanel extends AdminBreadCrumbPanel {
    ...
    public SetMembershipsPanel(final String id, final IPluginContext context,
        ...
        localList = new
                ...
                MembershipsListEditView("local-memberships", "local-membership", user);
        ...
        externalLabel.setVisible((user.getExternalMemberships().

                size()

                > 0));
        externalList.setVisible((user.getExternalMemberships().
                ...
                public void onClick(final AjaxRequestTarget target) {
                    try {
                        ...
                        HippoEvent event = new HippoEvent(userSession.getApplicationName())
                                ...
                                .category(HippoAdminConstants.CATEGORY_GROUP_MANAGEMENT)
                                .message("removed user " + user.getUsername() + " from group "
                                        + model.getGroup().getGroupname());
                        AuditLogger.getLogger().info(event.toString());
